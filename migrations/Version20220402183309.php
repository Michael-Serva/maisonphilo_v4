 ...
 */
final class Version20220402183309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       /*  $this->addSql('ALTER TABLE hospital ADD is_valid TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hospital DROP is_valid');
